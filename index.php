...
<body>
    ...
    <div class="remocon">
        <div class="remocon__item">
            <object data="images/icon/arrow_up.svg" type="image/svg+xml"></object>
        </div>
        <div class="remocon__item">
            <object data="images/icon/arrow_down.svg" type="image/svg+xml"></object>
        </div>
    </div>
    <div id="main" class="padding page">
        ...
        <object data="images/monster.svg" type="image/svg+xml" class="monster"></object>
    </div>
    <div class="find page padding">
        ...
        <div class="find__list">
            <div class="find__item">
                <div class="find__img">
                    <object data="images/icon/mouse.svg" type="image/svg+xml"></object>
                </div>
            ...
            <div class="find__item">
                <div class="find__img">
                    <object data="images/icon/ice.svg" type="image/svg+xml"></object>
                </div>
            ...
            <div class="find__item">
                <div class="find__img">
                    <object data="images/icon/tropy.svg" type="image/svg+xml"></object>
                </div>
    ...
    <div class="recommend page padding">
        ...
        <div class="cooks">
                ...
                <div class="cook__item">
                    <div class="cook__circle">
                        <div class="cook__heart">
                            <object data="images/icon/heart.svg" type="image/svg+xml"></object>
                        </div>
                    </div>
                    <div class="cook__img">
                        <img src="images/누룽지탕.JPG" alt="img">
                    </div>
            ...
            <div class="cook__button button">
                더보기
                <object data="images/icon/plus.svg" type="image/svg+xml"></object>
            </div>
        </div>
    </div>
    <div class="community page padding">
        <div class="community__wrap">
            ...
            <div class="community__button button">
                커뮤니티 바로가기
                <object class="community__button-arrow" data="images/icon/arrow_down_w.svg" type="image/svg+xml"></object>
            </div>
        </div>
        <div class="community__wrap">
            ...
            <div class="community__img">
                <object data="images/desk.svg" type="image/svg+xml" class="community__img--left"></object>
                <object data="images/monster_sit.svg" type="image/svg+xml"></object>
            </div>
        </div>
    ...
    <div class="fridge page padding">
        ...
        <div class="fridge__img">
            <div class="fridge__item">
                <object data="images/fridge.svg" type="image/svg+xml"></object>
            </div>
            <div class="fridge__item">
                <object data="images/monster_stand.svg" type="image/svg+xml"></object>
            </div>
        </div>
